...
insert into users(userid,username,city,country)
 values ('114','Amos','Ebonyi','Nigeria');
insert into Users(userid,username,city,Country)
values ('115',',Jude','Abia','Nigeria');
...
insert into Products(Productid,Productname,colour,unit)
values ('4516','Refrigerator','silver','3');
insert into Products(Productid,Productname,colour,unit)
values('6453','microwave','Red','16');
...
insert into Deliveries (Deliveryid,Quantity,city,country)
values ('2533','6','Benue','Nigeria');
insert into Deliveries(Deliveryid,Quantity,city,country)
values ('2367','22','Delta','Nigeria');
